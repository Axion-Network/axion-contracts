import { AuctionInstance, TokenInstance } from '../../types/truffle-contracts';
const auctionSnapshot = require('../../real-snapshots/auction-snapshot.json');
import _ from 'lodash';

export async function restoreAuctionSnapshot(
...
async function setReservesOf(auction: AuctionInstance) {
