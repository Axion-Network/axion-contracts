...
contract Staking is IStaking, Initializable, AccessControlUpgradeable {
    ...
    uint256 internal nextPayoutCall;
    uint256 public stepTimestamp;
    uint256 public startContract;
    uint256 internal globalPayout;
    uint256 internal globalPayin;
    uint256 internal lastSessionId;
    uint256 internal lastSessionIdV1;
    ...
    function restakeV1(uint256 sessionId, uint256 stakingDays) external {
        ...
        require(shares != 0, 'Staking: Stake withdrawn/invalid');
